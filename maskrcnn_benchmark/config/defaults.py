...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = num_class
...
# ---------------------------------------------------------------------------- #
_C.MODEL.FCOS = CN()
_C.MODEL.FCOS.NUM_CLASSES = num_class  # the number of classes including background
...
_C.MODEL.RETINANET.NUM_CLASSES = num_class
...
_C.SOLVER.CHECKPOINT_PERIOD = 5000  # how many iter save checkpoint
_C.SOLVER.TEST_PERIOD = 5000         # how many iter test
